...
**Columns:** each task lists its ID, description, dependencies (other task IDs),
priority, effort, the file(s) it touches, and concrete acceptance criteria.
